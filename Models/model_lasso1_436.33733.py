...
# Creating lasso regression object and predictors
model = linear_model.Lasso(fit_intercept=True, normalize=True)
...
# Model 8: Predictions = Lasso regression (default params) using sparse
...
plt.savefig('../Plots/lasso1_actual_vs_predictions.png')

# Creating a submission file
submission_model = test[['date', 'visitors_pool_total']]
submission_model.to_csv('../Submissions/submission_lasso1_ ' +
