...
# Removing outliers (days with viitors >= 2500)
train = train[train['visitors_pool_total'] < 2500]
...
# Model 6: Predictions = Linear regression using variables from main training
# file plus derived variable - 'day of the week' (excluding weather data).
# Exclude outliers (all data points where visitors >= 2500)
# [SCORE: 603.26095]
...
plt.savefig('../Plots/linear_regression3_actual_vs_predictions.png')

# Creating a submission file
submission_model = test[['date', 'visitors_pool_total']]
submission_model.to_csv('../Submissions/submission_linear_regression3_ ' +
